...
│       ├── controllers/
│       │   └── auth.controller.js  # Auth logic (register, login, OAuth, OTP)
│       ├── middleware/
│       │   └── auth.middleware.js   # JWT protect middleware
│       ├── models/
│       │   ├── User.model.js
│       │   ├── Canvas.model.js
│       │   ├── CanvasEvent.model.js
│       │   ├── CanvasState.model.js
│       │   ├── CanvasAccess.model.js
│       │   └── PasswordResetToken.model.js
│       ├── routes/
│       │   ├── auth.routes.js      # Auth endpoints
│       │   └── canvas.js           # Canvas CRUD & event endpoints
│       └── utils/
...
└── frontend/
    ...
    └── src/
        ...
        │       ├── components/
        │       │   ├── Canvas.jsx          # Core rendering & interaction
        │       │   ├── CanvasHeader.jsx    # Title bar with editable name
        │       │   ├── CanvasPage.jsx      # Full-page layout wrapper
        │       │   ├── Elements.jsx        # Shape/element rendering
        │       │   ├── PropertiesPanel.jsx # Style editor sidebar
        │       │   └── Toolbar.jsx         # Drawing tools & actions
        │       ├── hooks/
        │       │   └── useCanvas.js        # Core state management hook
        │       ├── pages/
        │       │   ├── MultiCanvasLobby.jsx
        │       │   ├── MultiCanvasJoin.jsx
        │       │   ├── MultiCanvasInitialization.jsx
        │       │   └── MyCanvases.jsx
        │       └── utils/
        │           ├── geometry.js         # Shape math helpers
        │           └── thumbnail.js        # Canvas thumbnail generation
        │
        ├── pages/
        ...
        │
        ├── utils/
        │   ├── api.js              # Canvas API call wrappers
